...
curl --request GET \--url http://localhost:3000/protected/blog/1 \--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4MWZhMWQ2OGU1NjMzYTc5Yjc2YmI1OSIsImlhdCI6MTc0NjkwNTM3MCwiZXhwIjoxNzQ2OTkxNzcwfQ.c5KQX90wt-cZ3Ij8Sn9QfWdG10gkH44GkH-rwl91VuA'

# Rota para editar uma postagem completamente
curl --request PUT \--url http://localhost:3000/protected/blog/1 \--header 'Content-Type: application/json' \--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4MWZhMWQ2OGU1NjMzYTc5Yjc2YmI1OSIsImlhdCI6MTc0NjkwNTM3MCwiZXhwIjoxNzQ2OTkxNzcwfQ.c5KQX90wt-cZ3Ij8Sn9QfWdG10gkH44GkH-rwl91VuA' \--data '{"title":"TITULO NOVO POR PUT 3","content":"isso e um teste NOVO"}'

# Rota para editar uma postagem parcialmente
curl --request PATCH \--url http://localhost:3000/protected/blog/5 \--header 'Content-Type: application/json' \--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4MWZhMWQ2OGU1NjMzYTc5Yjc2YmI1OSIsImlhdCI6MTc0NjkwNTM3MCwiZXhwIjoxNzQ2OTkxNzcwfQ.c5KQX90wt-cZ3Ij8Sn9QfWdG10gkH44GkH-rwl91VuA' \--data '{"title":"TITULO NOVO POR patch 3"}'

# Rota para deletar uma postagem
curl --request DELETE \--url http://localhost:3000/protected/blog/1 \--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4MWZhMWQ2OGU1NjMzYTc5Yjc2YmI1OSIsImlhdCI6MTc0NjkwNTM3MCwiZXhwIjoxNzQ2OTkxNzcwfQ.c5KQX90wt-cZ3Ij8Sn9QfWdG10gkH44GkH-rwl91VuA'
